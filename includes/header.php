...
header("Content-Security-Policy: default-src 'self'; script-src 'self' https://cdn.jsdelivr.net https://animejs.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; img-src 'self' data:; font-src 'self' https://cdn.jsdelivr.net; connect-src 'self';");
...
<link rel="stylesheet" href="/citas_medicas/assets/css/animations.css">
<link href="https://cdn.jsdelivr.net/npm/boxicons@2.1.4/css/boxicons.min.css" rel="stylesheet">
<!-- Anime.js para animaciones centralizadas -->
<script src="https://animejs.com/lib/anime.min.js"></script>
<script src="/citas_medicas/assets/js/animations.js" defer></script>
...
<header id="header">
    ...
    <div class="nav">
        ...
        <?php if(isset($_SESSION['usuario'])): ?>
            ...
            <span><?= esc($_SESSION['usuario'] ?? '') ?></span>
